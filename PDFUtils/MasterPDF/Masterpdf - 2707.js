...
exports.pdfgenerate = async (InvoiceMAsterpdf, PdfContacts, address) => {
    ...
    if (address) {
        ...
        cityName = (addressDetails.City[0].CityName == null || addressDetails.City[0].CityName == '' || addressDetails.City[0].CityName == 'N/A') ? '' : addressDetails.City[0].CityName;
        console.log("C \n " + JSON.stringify(cityName));
        stateName = (addressDetails.State[0].StateName == null || addressDetails.State[0].StateName == '' || addressDetails.State[0].StateName == 'N/A') ? '' : addressDetails.State[0].StateName;
        console.log("stateName \n " + JSON.stringify(stateName));
        countryName = (addressDetails.Country[0].CountryName == null || addressDetails.Country[0].CountryName == '' || addressDetails.Country[0].CountryName == 'N/A') ? '' : addressDetails.Country[0].CountryName;
    }
    ...
    for (let index = 0; index < InvoiceMAsterpdf.length; index++) {
        ...
        let records = [
            ...
            { text: dateFormat(InvoiceMAster.Job_date === undefined ? InvoiceMAster.Job_date : '', "dd-mm-yyyy"), alignment: 'left' },
            { text: dateFormat(InvoiceMAster.Expiry_date === undefined ? InvoiceMAster.Expiry_date[0] : '', "dd-mm-yyyy"), alignment: 'left' },
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [{ text: 'Ref-1', bold: true }, { text: InvNum }],
                                ]
                            }
                        },
                    ],
                    ...
                    columns: [
                        {
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [{ text: 'Attention ', bold: true }, ':', { text: singleInvoiceData.Customer_name == null ? '' : singleInvoiceData.Customer_name, bold: true }],
                                ]
                            },
                            layout: 'noBorders'
                        },
...
exports.pdfgenerateSingleInvocie = async (InvoiceMAsterpdf, PdfContacts, address) => {
    ...
    for (let index = 0; index < InvoiceMAsterpdf.length; index++) {
        ...
        GSTTotal = Number(GSTTotal) + Number(InvoiceMAster.Gst_amount[1]);

        console.log("TotalSales\n" + TotalSales + " " + InvoiceMAster.Amount)
        console.log("GSTT-----" + JSON.stringify(GSTTotal));

        AmountPay = Number(AmountPay) + (Number(TotalSales) + Number(GSTTotal));
        ...
        let InspName = 'PO / Inspector Name : ' + (InvoiceMAster.Inspector_Name === null || InvoiceMAster.Inspector_Name === undefined) ? '' : InvoiceMAster.Inspector_Name
        ...
        let records = [
            ...
            { text: discreptionText + "  " + '\nProduct Name : ' + product + "\n " + 'License No: ' + licenceNo + " \n " + 'PO/ Inspector Name : ' + InspName + "\n " + AuditName + " \n" + Job_id, alignment: 'left', margin: [-60, 0, 40, 0] },
            { text: dateFormat(InvoiceMAster.Job_date, "dd-mm-yyyy"), alignment: 'left', style: 'tableHeader' },
            { text: dateFormat(InvoiceMAster.Expiry_date === undefined ? InvoiceMAster.Expiry_date[0] : '', "dd-mm-yyyy"), alignment: 'left' },
                    ...
                    columns: [
                        {
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [{ text: 'Attention ', bold: true }, ':', { text: singleInvoiceData.Customer_name ? '' : singleInvoiceData.Customer_name, bold: true }],
                                ]
                            },
                            layout: 'noBorders'
                        },
